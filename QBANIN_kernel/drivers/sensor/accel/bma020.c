...
*/	
	...
	acc->x -= cal_data.x;	//modded by QBANIN : default without "+/-0"
	acc->y -= cal_data.y;	//modded by QBANIN : default without "+/-0"
	acc->z -= cal_data.z+10; 	//modded by QBANIN : default without "+/-0"
...
bma020acc_t bma020_calibrate()
{
	...
	cal_data.z = (sum_z / 20) - 256; //orig -256
